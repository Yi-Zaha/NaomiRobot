...
import html
import requests
import Naomi.modules.sql.chatbot_sql as sql
...
from Naomi.modules.helper_funcs.chat_status import user_admin, user_admin_no_reply
...
def chatbot(update: Update, context: CallbackContext):
    ...
    if message.text and not message.document:
        ...
        kukiurl = requests.get(f'https://www.kukiapi.xyz/api/apikey=KUKIg76Fg4EIo/Cutiepii/@Awesome_RJ/message='+Message)
